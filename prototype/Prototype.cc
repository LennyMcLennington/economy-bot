...
public:
	...
	public:
		...
		Command(std::initializer_list<std::string> aliases, std::string desc, std::string category, arginfo_type args, run_fn_type f)
...
int main()
{
	...
	handler.register_command({"cmd", "cmd_name"}, "The description of the command", "general", CommandHandler<>::CommandOptions{},
